...
using Specifications.IntegrationTests.Infrastructure;
using Specifications.IntegrationTests.Internal;
using System;
using System.Collections.Generic;
using System.Linq;
using Xunit;

namespace Specifications.IntegrationTests
{
    public class DatabaseTests
    {
        ...
        [Fact]
        [ResetDatabase]
        public void When_TwoSpec_OrderWithPriduct_Then_OneOrder()
        {
